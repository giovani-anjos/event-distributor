...
def get_pending_files():
    try:
        ...
        print("An exception occurred at get_pending_files() method") 
...
def parser_to_s3(files):
    try:
        ...
        print("An exception occurred at parser_to_s3() method")
...
def move_pending_files_to_processed(files):
    try:
        ...
        print("An exception occurred at move_pending_files_to_processed() method")
